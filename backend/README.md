...
## Project Structure
    ...
    ├── frosty_moon_dev_102299  # Django project configurations
...
1. Clone this repo and `cd frosty_moon_dev_102299`
...
2. Clone this repo and `cd frosty_moon_dev_102299`
