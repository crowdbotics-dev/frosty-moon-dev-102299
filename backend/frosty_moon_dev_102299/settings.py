"""
Django settings for frosty_moon_dev_102299 project.
...
ROOT_URLCONF = 'frosty_moon_dev_102299.urls'
...
WSGI_APPLICATION = 'frosty_moon_dev_102299.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "frosty_moon_dev_102299 API",
    "DESCRIPTION": "API documentation for frosty_moon_dev_102299 App",
    "VERSION": "v1",
}
